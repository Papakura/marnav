...
public:
    /*!
     *
     * @return The current set of labels
     */
	const labels& get_labels() const	{ return labels_; };

	/*!
	 * Add a new label to the sentence
	 * @param label The label to add
	 * @return true, if label added. false if sentence size reached
	 */
